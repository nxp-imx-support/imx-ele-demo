...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->screen_cont_1, 1280, 720);
	...
	lv_img_set_src(ui->screen_img_1, &_whitebg1_alpha_1280x720);
	lv_img_set_pivot(ui->screen_img_1, 50,50);
	lv_img_set_angle(ui->screen_img_1, 0);
	lv_obj_set_pos(ui->screen_img_1, 0, 0);
	lv_obj_set_size(ui->screen_img_1, 1280, 720);
	...
	lv_obj_set_pos(ui->screen_cont_3, 0, 106);
	lv_obj_set_size(ui->screen_cont_3, 480, 613);
	...
	lv_obj_set_pos(ui->screen_notes, 36, 546);
	lv_obj_set_size(ui->screen_notes, 382, 52);
	...
	lv_obj_set_style_text_font(ui->screen_notes, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_opa(ui->screen_notes, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_generate, 57, 457);
	lv_obj_set_size(ui->screen_generate, 134, 76);
	...
	lv_obj_set_style_radius(ui->screen_generate, 13, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_generate, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_clear, 267, 457);
	lv_obj_set_size(ui->screen_clear, 134, 76);
	...
	lv_obj_set_style_radius(ui->screen_clear, 13, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_clear, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_nums, 48, 27);
	lv_obj_set_size(ui->screen_nums, 368, 42);
	...
	lv_obj_set_style_text_font(ui->screen_nums, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_cont_4, 486, 106);
	lv_obj_set_size(ui->screen_cont_4, 790, 613);
	...
	lv_obj_set_pos(ui->screen_exit, 613, 457);
	lv_obj_set_size(ui->screen_exit, 126, 74);
	...
	lv_obj_set_style_radius(ui->screen_exit, 13, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_exit, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_img_dec, 560, 86);
	lv_obj_set_size(ui->screen_img_dec, 184, 274);
	...
	lv_obj_set_pos(ui->screen_img_ori, 53, 86);
	lv_obj_set_size(ui->screen_img_ori, 184, 274);
	...
	lv_obj_set_pos(ui->screen_img_enc, 306, 86);
	lv_obj_set_size(ui->screen_img_enc, 184, 274);
	...
	lv_obj_set_pos(ui->screen_encrypt, 280, 457);
	lv_obj_set_size(ui->screen_encrypt, 134, 76);
	...
	lv_obj_set_style_radius(ui->screen_encrypt, 13, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_encrypt, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_decrypt, 446, 457);
	lv_obj_set_size(ui->screen_decrypt, 134, 76);
	...
	lv_obj_set_style_radius(ui->screen_decrypt, 13, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_decrypt, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_mod, 32, 448);
	lv_obj_set_width(ui->screen_mod, 212);
	...
	lv_obj_set_style_radius(ui->screen_mod, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_mod, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_border_side(ui->screen_mod, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_left(ui->screen_mod, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_right(ui->screen_mod, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_mod, &lv_font_montserratMedium_20, LV_PART_SELECTED|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_window, 210, 28);
	lv_obj_set_size(ui->screen_window, 290, 158);
	...
	lv_obj_set_pos(ui->screen_OK_BTN, 113, 108);
	lv_obj_set_size(ui->screen_OK_BTN, 66, 33);
	...
	lv_obj_set_style_radius(ui->screen_OK_BTN, 6, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_OK_BTN, &lv_font_montserratMedium_13, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_content, &lv_font_montserratMedium_10, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->screen_content, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_remind, 46, 18);
	lv_obj_set_size(ui->screen_remind, 209, 21);
	...
	lv_obj_set_style_text_font(ui->screen_remind, &lv_font_montserratMedium_10, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_size(ui->screen_cont_5, 1280, 100);
	...
	lv_obj_set_pos(ui->screen_label_5, 40, 23);
	lv_obj_set_size(ui->screen_label_5, 387, 49);
	...
	lv_obj_set_style_text_font(ui->screen_label_5, &lv_font_montserratMedium_33, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->screen_NXP_logo, &_NXP_Logo_RGB_Colour_alpha_146x72);
	lv_img_set_pivot(ui->screen_NXP_logo, 50,50);
	lv_img_set_angle(ui->screen_NXP_logo, 0);
	lv_obj_set_pos(ui->screen_NXP_logo, 1106, 8);
	lv_obj_set_size(ui->screen_NXP_logo, 146, 72);
